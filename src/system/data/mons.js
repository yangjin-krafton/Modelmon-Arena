...
function transformMons(rows, evoMap) {
  return rows.map(r => ({
    ...
    evoLineId:   r.evo_line_id || null,
    evoLineName: r.evo_line_name || null,
    evoTier:     r.evo_tier || null,
    skillTrick:  r.skill_trick || null,
    bst:         r.bst ? parseInt(r.bst) : null,
    lv1: {
      hp:  r.lv1_hp ? parseInt(r.lv1_hp) : null,
      atk: r.lv1_atk ? parseInt(r.lv1_atk) : null,
      def: r.lv1_def ? parseInt(r.lv1_def) : null,
      spd: r.lv1_spd ? parseInt(r.lv1_spd) : null,
      spc: r.lv1_spc ? parseInt(r.lv1_spc) : null,
    },
    lv100: {
      hp:  r.lv100_hp ? parseInt(r.lv100_hp) : null,
      atk: r.lv100_atk ? parseInt(r.lv100_atk) : null,
      def: r.lv100_def ? parseInt(r.lv100_def) : null,
      spd: r.lv100_spd ? parseInt(r.lv100_spd) : null,
      spc: r.lv100_spc ? parseInt(r.lv100_spc) : null,
    },
    bs: {
      hp:  parseInt(r.bs_hp),
